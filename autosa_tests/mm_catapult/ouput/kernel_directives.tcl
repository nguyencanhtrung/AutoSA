...
solution file add ./kernel_kernel.h -type CHEADER
solution file add ./kernel_kernel_hw.h -type CHEADER
solution file add ./kernel.h -type CHEADER
solution file add ./kernel_host.cpp -type C++
...
directive set /kernel0/A_IO_L2_in/A_IO_L2_in_local_A_inst -WORD_WIDTH 512
...
directive set /kernel0/A_IO_L2_in_boundary/A_IO_L2_in_local_A_inst -WORD_WIDTH 512
...
directive set /kernel0/B_IO_L2_in/B_IO_L2_in_local_B_inst -WORD_WIDTH 512
...
directive set /kernel0/B_IO_L2_in_boundary/B_IO_L2_in_local_B_inst -WORD_WIDTH 512
...
directive set /kernel0/C_drain_IO_L1_out/C_drain_IO_L1_out_local_C_inst -WORD_WIDTH 128
...
directive set /kernel0/C_drain_IO_L1_out_boundary/C_drain_IO_L1_out_local_C_inst -WORD_WIDTH 128
go architect
...
#kernel_directives.tcl
# directive set \
#   /kernel0/PE/run/for:for:for:for:for#2:read_mem(local_C:rsc.@) \
#   -IGNORE_DEPENDENCY_FROM \
#   {/kernel0/PE/run/for:for:for:for:for#2:write_mem(local_C:rsc.@) /kernel0/PE/run/for:for:for:for:if:write_mem(local_C:rsc.@)}

# directive set \
#   /kernel0/PE/run/for:for:for:for:for#2:write_mem(local_C:rsc.@) \
#   -IGNORE_DEPENDENCY_FROM \
#   {/kernel0/PE/run/for:for:for:for:if:write_mem(local_C:rsc.@)}
